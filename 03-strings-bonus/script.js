...
//const citySubstring = city.substring(4); non supporta indici negativi [variante]
//const citySubstring = city.slice(-4); or const citySubstring = city.slice(0, -4);  [variante]
const citySubstring = city.slice(4);
console.log(citySubstring); // Output: "York"

// 3. Sostituzione
// Sostituisci 'York' con 'Delhi'
const cityReplaced =city.replace('York', 'Delhi'); // .replace('parte da sostituire', 'parte nuova')
